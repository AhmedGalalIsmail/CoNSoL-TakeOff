...
# 📘 0104 — Software Requirements Specification (SRS) ^010400
...
## 1. Introduction ^010401

### 1.1 Purpose ^0104010101
...
#### Out of Scope (v1) ^010402OutofScope
...
### 1.3 Definitions & Acronyms ^0104010103
...
## 2. Overall Description ^010402

### 2.1 Product Perspective ^01040201

The Drawing Engine is a **library**, not a standalone app.

_It is consumed by:_
- CoNSoL‑TakeOff (standalone)
- CoNSoL‑Suite (integrated)

---

### 2.2 Operating Environment ^01040202
...
### 2.3 Design Constraints ^01040203
...
## 3. Stakeholders & User Classes ^010403
...
## 4. System Context & Deployment ^010404
...
## 5. Functional Requirements ^010405

### 5.1 Drawing Tools ^01040501
...
### 5.2 Canvas & Coordinate System ^01040502
...
## 6. UI & Interaction Requirements ^010406
...
## 7. Non‑Functional Requirements ^010407
...
## 8. Component Architecture ^010408
