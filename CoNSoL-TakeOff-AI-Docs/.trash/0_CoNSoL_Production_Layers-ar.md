...
1. `Calculator.Calculate(shape, dimensionMode)` — تفعيل D0/D1/D2/D3
...
4. `TakeOffService.GetSummary()` — تجميع البيانات حسب المجموعة، وإرجاع صفوف الجدول
...
[ ] UC-001 من البداية إلى النهاية: الرسم ← الحفظ ← إعادة التحميل تُظهر الشكل الصحيح
[ ] UC-004 من البداية إلى النهاية: رسم الكائنات ← تشغيل عملية حساب الكميات ← تصدير ملف CSV
[ ] UC-002 من البداية إلى النهاية: تعيين كائن إلى طبقة، تبديل إظهار/قفل الطبقة
[ ] UC-007 من البداية إلى النهاية: حذف طبقة، إعادة تعيين الكائنات
