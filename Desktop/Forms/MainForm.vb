...
Namespace Forms
	...
	Public Class MainForm
		...
		Public Sub New()
			...
			SuspendLayout()
			BuildFrame() ' create controls, add them
			ResumeLayout(False)
		...
		Private Sub MainForm_Load(sender As Object, e As EventArgs) Handles Me.Load
			' Now the controls have been measured: set splitter / min sizes safely
			If _contentSplit.Width >= 860 Then
			...
			Else
				...
				_contentSplit.Panel1MinSize = Math.Min(640, _contentSplit.Width * 2 \ 3)
				_contentSplit.Panel2MinSize = Math.Min(220, _contentSplit.Width \ 3)
				_contentSplit.SplitterDistance = Math.Max(_contentSplit.Panel1MinSize, _contentSplit.Width - _contentSplit.Panel2MinSize)
			End If
		End Sub
		Private Sub BuildFrame()
			...
			Else
				...
				_contentSplit.SplitterDistance = Math.Max(_contentSplit.Panel1MinSize, _contentSplit.Width - _contentSplit.Panel2MinSize)
			End If
			'_contentSplit.SplitterDistance = 30
...
'        ''' </remarks>
'        Public Sub New(_layerManager As LayerManager())
...
'            ' ? 4. Prepare layout
'            Dim layout As New CanvasLayout()
'            Dim defaultLayer = _layerManager.EnsureDefaultLayer() 'GetDefaultLayer()
