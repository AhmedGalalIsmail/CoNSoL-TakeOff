...
Partial Public Class TakeOffCanvas
	Public Class SelectedElementBox
...
#Region "Private variables"
		...
		Public LinkedPictureBox As TakeOffCanvas
...
#End Region
#Region "Operators"
		Public Shared Widening Operator CType(ByVal box As SelectedElementBox) As RECT
...
#End Region
#Region "Constructors"
		Public Sub New(ByVal picBox As TakeOffCanvas)
