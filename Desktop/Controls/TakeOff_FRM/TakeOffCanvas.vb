...
#End Region
#Region "Events"
    Public Shadows Event MouseClick(ByVal sender As TakeOffCanvas, ByVal e As System.Windows.Forms.MouseEventArgs, ByVal LogicalCoord As Point, ByVal CurrentClickAction As ToolType)
    Public Shadows Event MouseMove(ByVal sender As TakeOffCanvas, ByVal e As System.Windows.Forms.MouseEventArgs, ByVal LogicalCoord As Point, ByVal CurrentClickAction As ToolType)
    Public Shadows Event MouseDown(ByVal sender As TakeOffCanvas, ByVal e As System.Windows.Forms.MouseEventArgs, ByVal LogicalCoord As Point, ByVal CurrentClickAction As ToolType)
    Public Shadows Event MouseUp(ByVal sender As TakeOffCanvas, ByVal e As System.Windows.Forms.MouseEventArgs, ByVal LogicalCoord As Point, ByVal CurrentClickAction As ToolType)
    Public Shadows Event MouseEnter(ByVal sender As TakeOffCanvas, ByVal e As System.EventArgs)
    Public Shadows Event MouseLeave(ByVal sender As TakeOffCanvas, ByVal e As System.EventArgs)
    Public Shadows Event Paint(ByVal sender As TakeOffCanvas, ByVal e As System.Windows.Forms.PaintEventArgs)

    Public Event OnMeasureCompleted(ByVal sender As TakeOffCanvas, ByVal StartPoint As Point, ByVal EndPoint As Point)
    Public Event OnRedrawCompleted(ByVal sender As TakeOffCanvas, ByVal CacheRebuilded As Boolean)
    Public Event OnPictureBoxDoubleClick(ByVal sender As TakeOffCanvas, ByVal e As System.Windows.Forms.MouseEventArgs, ByVal LogicalCoord As Point)
    Public Event OnMinimumZoomLevelReached(ByVal sender As TakeOffCanvas)
    Public Event OnMaximumZoomLevelReached(ByVal sender As TakeOffCanvas)
...
#Region "Various"
    ...
    Private myRulers As New TakeOffRulers(Me)
...
#Region "Selection/zoom box"
    Private mySelectionBox As New SelectedElementBox(Me)
#End Region
...
#Region "Griglia e Snap"
    <Description("Imposta la modalità di visualizzazione delle griglie"),
    ...
    ''' </summary>
    <Description("Imposta il passo della griglia"),
     DefaultValue(10000)>
...
#Region "Menu di contesto"
    Public Event ShowContextMenuRequired(ByVal sender As TakeOffCanvas, ByVal X As Single, ByVal Y As Single)
    Public Sub RaiseContextMenuRequest(ByVal sender As TakeOffCanvas, ByVal X As Single, ByVal Y As Single)
        Try
...
#Region "Cursori"
    ...
    Protected Overrides ReadOnly Property DefaultCursor() As Cursor
        Get
            If Me.ClickAction = ToolType.Zoom Then
...
#Region "Selection/zoom box"
    Public ReadOnly Property SelectionBox() As SelectedElementBox
        Get
...
#Region "Variabili per il Resize()"
    <DefaultValue(GetType(ResizeMode), "Stretch")>
...
#End Region
    ...
    ''' </summary>
    <Description("Imposta il bordo della PictureBox"),
    ...
    <Description("Imposta l'unità di misura del sistema di coordinate logico della PictureBox"),
...
#Region "Gestione input da tastiera"
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As Message, ByVal keyData As Keys) As Boolean
        ...
        Try
            ...
            ' Output di debug
            If (msgKey <> Keys.Control) AndAlso (msgKey <> Keys.Shift) AndAlso (msgKey <> Keys.Alt) AndAlso
