Imports Desktop.TakeOffCanvas

Public Class cZoomButtonTakeOff
    Inherits UserControl

    Private WithEvents myZRGPictureBox As TakeOffCanvas 'ZRGPictureBox.ZRGPictureBoxControl
    Public Property LinkedPictureBox As TakeOffCanvas 'ZRGPictureBox.ZRGPictureBoxControl
        Get
            Return myZRGPictureBox
        End Get
        Set(value As TakeOffCanvas) 'ZRGPictureBox.ZRGPictureBoxControl)
