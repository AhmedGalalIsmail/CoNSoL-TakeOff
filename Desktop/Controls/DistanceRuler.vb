...
Public Class DistanceRuler
	...
	''' <summary>
	''' Gets or sets an array values that specify a compound pen. <br></br>A compound pen draws a compound line made up of parallel lines and spaces.
	''' </summary>
	''' <value>An array of single values.</value>
	''' <remarks>A compound line is made up of alternating parallel lines and spaces of varying widths.<br></br>
	''' The values in the array specify the starting points of each component of the compound line<br></br>
	''' relative to the pen's width. The first value in the array specifies where the first component<br></br>
	''' (a line) begins as a fraction of the distance across the width of the pen. The second value in the<br></br>
	''' array specifies the beginning of the next component (a space) as a fraction of the distance across<br></br>
	''' the width of the pen. The final value in the array specifies where the last component ends.<br></br>
	''' Suppose you want a pen to draw two parallel lines where the width of the first line is 20 percent of<br></br> 
	''' the pen's width, the width of the space that separates the two lines is 50 percent of the pen' s width,<br></br>
	''' and the width of the second line is 30 percent of the pen's width. Start by creating a Pen object and<br></br>
	''' an array of real numbers.<br></br>
	...
	''' <summary>Returns a double value with the specified number of decimal digits. The value is truncated, not rounded.</summary>
	''' <param name="Value"></param><param name="DesiredDecDigits"></param>
	...
	''' <summary>Returns a string value with the specified number of decimal digits.</summary>
	''' <param name="Value"></param><param name="DesiredDecDigits"></param>
	...
	Friend Sub Painting(ByVal GR As Graphics, Optional ByVal ScaleFactor As Double = 1.0)
		...
		Using wallpen As New Pen(myPictureBoxControl.ForeColor, 1)
			...
			' 
			GR.DrawLine(wallpen, _origin.X - OriginCrossArmLength, _origin.Y,
						_origin.X + OriginCrossArmLength, _origin.Y)
			GR.DrawLine(wallpen, _origin.X, _origin.Y - OriginCrossArmLength,
						_origin.X, _origin.Y + OriginCrossArmLength)
			GR.DrawArc(wallpen, _origin.X - OriginCrossArmLength, _origin.Y - OriginCrossArmLength,
					   2 * OriginCrossArmLength, 2 * OriginCrossArmLength, 0, CInt(-CurrentAngle))

			Using mx As New System.Drawing.Drawing2D.Matrix
				Using sf As New StringFormat()
					Dim ls As String = ""
					ls = Format(LineLength(_origin, _last, Scale) / ScaleFactor, "#.00") +
						"  (" + strCutDecimals(CurrentAngle, 1) + "°)"
					Dim l As SizeF = GR.MeasureString(ls, myPictureBoxControl.Font,
